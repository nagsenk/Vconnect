...
urlpatterns = [
    ...
    path('teacher/upload', views.educator_upload, name='educator_upload'),
    path('teacher/my_uploads', views.educator_myuploads, name='educator_myuploads'),
    ...
    path('parentsignup/', views.hostel_add, name='parentsignup'),
    path('hosteladd/', views.hostel_add, name='hostel_add'),
    path('hostelallot/', views.hostel_allot, name='hostel_allot'),
    ...
    #               STUDENT URLS
    # -------------------------------------------------------------------------------------------
    #spath('student/<int:educator_id>', views.educator_login_view, name='educator_login_view'),
    ...
    path('student/<int:student_id>/<slug:subject>', views.student_subject, name='student_subject'),
    path('student/<int:student_id>/<slug:subject>/subject_selected', views.subject_selected, name='subject_selected'),
    path('student/<int:student_id>/<slug:subject>/<slug:type>',views.student_display, name='student_display'),
    path('student/<int:student_id>/<slug:subject>/videos',views.subject_videos, name='subject_videos'),
    path('student/<int:student_id>/<slug:subject>/<slug:assignments>',views.subject_assignment, name='subject_assignment'),
    path('student/<int:student_id>/<slug:subject>/<slug:study_material>',views.subject_studymaterial, name='subject_studymaterial'),
    path('student/<int:student_id>/<slug:subject>/<slug:contacts>',views.subject_contacts, name='subject_contacts'),
